...
async function POST(req) {
    try {
        ...
        if (!response.ok) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: body.message || '결제 승인 모듈 자체 실패'
            }, {
        ...
        if (kakaoId) {
            const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createServiceClient"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e2d501c._.js.map