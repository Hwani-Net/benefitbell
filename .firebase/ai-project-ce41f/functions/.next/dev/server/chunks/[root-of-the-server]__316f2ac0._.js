...
/** Get benefit with live D-Day calculation */ function withLiveDDay(b) {
    const dDay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$welfare$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calculateDDay"])(b.applicationEnd);
    return {
        ...b,
        dDay,
...
;
/** Recalculate D-Day for mock benefits using applicationEnd */ function recalcMockBenefits() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$benefits$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BENEFITS"].map((b)=>{
        const dDay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$welfare$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calculateDDay"])(b.applicationEnd);
        const status = dDay < 0 ? 'closed' : 'open';
        return {
            ...b,
            dDay,
            status
...
async function GET(request) {
    ...
    try {
        ...
        const apiItems = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$welfare$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchWelfareList"])(1, 100);
        if (apiItems.length > 0) {
            const apiBenefits = apiItems.map((item, i)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$welfare$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["transformListItemToBenefit"])(item, i));
            ...
            if (keyword) {
                combined = combined.filter((b)=>b.title.includes(keyword) || b.ministry.includes(keyword) || b.description.includes(keyword));
            }
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                data: combined,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__316f2ac0._.js.map