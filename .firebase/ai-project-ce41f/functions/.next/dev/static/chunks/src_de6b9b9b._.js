        ...
        "AppProvider.useEffect": ()=>{
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChanged"])(auth, {
                "AppProvider.useEffect.unsubscribe": async (firebaseUser)=>{
                    ...
                    try {
                        const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFirebaseDb"])();
                        if (!db) return;
                        const kakaoId = firebaseUser.uid.replace('kakao_', '');
                        const userDoc = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(db, 'users', kakaoId));
                        if (userDoc.exists()) {
                            const data = userDoc.data();
                            setUserProfile({
                                "AppProvider.useEffect.unsubscribe": (prev)=>({
                                        ...prev,
...
_s(AppProvider, "52E60IYXL+Sn/ivOa4/mVVj+07I=");
_c = AppProvider;
function useApp() {
    _s1();
...
//# sourceMappingURL=src_de6b9b9b._.js.map