...
function CalendarPage() {
    _s();
    const { t, lang, toggleBookmark, isBookmarked, benefits: allBenefits, benefitsLoading: loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApp"])();
    const now = new Date();
    ...
    const handleShare = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CalendarPage.useCallback[handleShare]": async (benefitId, title)=>{
            ...
            if (navigator.share) {
                try {
                    ...
                    setTimeout({
                        "CalendarPage.useCallback[handleShare]": ()=>setSharedId(null)
                    }["CalendarPage.useCallback[handleShare]"], 2500);
                } catch (err) {
    ...
    }["CalendarPage.useCallback[handleShare]"], [
        lang
    ]);
...
_s(CalendarPage, "kFcVrJE+iVClwowbd2V8IWtTlZQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApp"]
    ];
});
...
//# sourceMappingURL=src_bae32500._.js.map