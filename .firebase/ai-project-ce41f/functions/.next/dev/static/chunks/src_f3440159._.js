...
function createServiceClient() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(supabaseUrl, supabaseServiceKey, {
        auth: {
...
function AppProvider({ children }) {
    ...
    const [kakaoUser, setKakaoUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppProvider.useEffect": ()=>{
            ...
            const getCookie = {
                "AppProvider.useEffect.getCookie": (name)=>{
                    const value = `; ${document.cookie}`;
                    const parts = value.split(`; ${name}=`);
                    if (parts.length === 2) return decodeURIComponent(parts.pop()?.split(';').shift() || '');
                    return null;
                }
            }["AppProvider.useEffect.getCookie"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppProvider.useEffect": ()=>{
            if (kakaoUser?.id) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('user_profiles').select('is_premium').eq('kakao_id', String(kakaoUser.id)).single().then({
...
_s(AppProvider, "WjT5HJg2V+AuHecGQvjoGh5YT9Y=");
_c = AppProvider;
function useApp() {
    _s1();
...
"[project]/src/components/pwa/InstallBanner.module.css [app-client] (css module)", ((__turbopack_context__) => {
...
"[project]/src/components/pwa/InstallBanner.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pwa$2f$InstallBanner$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/components/pwa/InstallBanner.module.css [app-client] (css module)");
;
...
function InstallBanner() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InstallBanner.useEffect": ()=>{
            ...
            if (isIOS && isSafari) {
                setPlatform('ios');
                setTimeout({
                    "InstallBanner.useEffect": ()=>setShow(true)
                }["InstallBanner.useEffect"], 3000);
                return;
            }
            // Android / Chrome: listen for beforeinstallprompt
            const handler = {
                "InstallBanner.useEffect.handler": (e)=>{
                    e.preventDefault();
                    setDeferredPrompt(e);
                    setPlatform('android');
                    // Show banner after 3 seconds
                    setTimeout({
                        "InstallBanner.useEffect.handler": ()=>setShow(true)
                    }["InstallBanner.useEffect.handler"], 3000);
                }
            }["InstallBanner.useEffect.handler"];
            window.addEventListener('beforeinstallprompt', handler);
            return ({
                "InstallBanner.useEffect": ()=>window.removeEventListener('beforeinstallprompt', handler)
            })["InstallBanner.useEffect"];
        }
    }["InstallBanner.useEffect"], []);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pwa$2f$InstallBanner$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].banner} ${show ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pwa$2f$InstallBanner$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].visible : ''}`,
        role: "dialog",
        "aria-label": "앱 설치 안내",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pwa$2f$InstallBanner$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].icon,
                children: "📲"
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pwa$2f$InstallBanner$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].content,
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pwa$2f$InstallBanner$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].title,
                        children: "홈 화면에 추가하기"
                    }, void 0, false, {
                        fileName: "[project]/src/components/pwa/InstallBanner.tsx",
                        lineNumber: 66,
                    ...
                    platform === 'ios' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pwa$2f$InstallBanner$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].desc,
                        children: [
                            "Safari 하단 ",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pwa$2f$InstallBanner$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].actions,
                children: [
                    platform === 'android' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        id: "pwa-install-btn",
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pwa$2f$InstallBanner$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].installBtn,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        id: "pwa-dismiss-btn",
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pwa$2f$InstallBanner$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].dismissBtn,
...
_s(InstallBanner, "lrAemRtdjKmjnzT8m9UkBpsNhkQ=");
_c = InstallBanner;
var _c;
...
"[project]/src/components/agentation/AgenationWrapper.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
function AgenationWrapper() {
    _s();
    const [AgentComp, setAgentComp] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AgenationWrapper.useEffect": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
                __turbopack_context__.A("[project]/node_modules/agentation/dist/index.mjs [app-client] (ecmascript, async loader)").then({
                    "AgenationWrapper.useEffect": (mod)=>{
                        setAgentComp({
                            "AgenationWrapper.useEffect": ()=>({
                                    "AgenationWrapper.useEffect": ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(mod.Agentation, {
                                            endpoint: "http://localhost:4747",
                                            onSessionCreated: {
                                                "AgenationWrapper.useEffect": (id)=>console.log('[Agentation] Session:', id)
                                            }["AgenationWrapper.useEffect"]
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/agentation/AgenationWrapper.tsx",
                                            lineNumber: 16,
                                            columnNumber: 11
                                        }, this)
                                })["AgenationWrapper.useEffect"]
                ...
                }["AgenationWrapper.useEffect"]).catch({
                    "AgenationWrapper.useEffect": ()=>{}
                }["AgenationWrapper.useEffect"]);
            }
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AgentComp, {}, void 0, false, {
        fileName: "[project]/src/components/agentation/AgenationWrapper.tsx",
        lineNumber: 26,
        columnNumber: 10
    }, this);
}
_s(AgenationWrapper, "n5vup7aEyX30+C1448Wawz9keXA=");
_c = AgenationWrapper;
var _c;
__turbopack_context__.k.register(_c, "AgenationWrapper");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_f3440159._.js.map