...
const verdictInfo = {
  likely: {
    icon: "✅",
    label: { ko: "가능성 높음", en: "Likely Eligible" },
    color: "#16a34a",
  },
  partial: {
    icon: "⚠️",
    label: { ko: "조건 확인 필요", en: "Partial Match" },
    color: "#b45309",
  },
  unlikely: {
    icon: "❌",
    label: { ko: "가능성 낮음", en: "Unlikely Eligible" },
    color: "#dc2626",
  },
};

export default function AiEligibilityCheck({
  benefitId,
  benefitTitle,
  variant = "modal",
}: Props) {
