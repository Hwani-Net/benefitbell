...
export const DOCUMENT_DATABASE: DocumentInfo[] = [
  ...
  },
  {
    ...
    issueUrl:
      "https://www.gov.kr/mw/AA020InfoCappView.do?HighCtgCD=A01010&CappBizCD=13100000016",
    freeOnline: true,
  ...
  },
  {
    ...
    issueUrl:
      "https://www.gov.kr/mw/AA020InfoCappView.do?HighCtgCD=A01010&CappBizCD=15000000089",
    freeOnline: true,
  ...
  // ── 기타 ─────────────────────────────────
  {
    ...
    issueUrl:
      "https://www.gov.kr/mw/AA020InfoCappView.do?HighCtgCD=A09002&CappBizCD=16100000035",
    freeOnline: true,
...
export function matchDocument(rawName: string): DocumentInfo | null {
  ...
  // 2. Substring match — require at least 3 chars to avoid false positives
...
export function matchDocuments(
  rawNames: string[],
): Array<DocumentInfo & { matched: boolean }> {
  return rawNames
