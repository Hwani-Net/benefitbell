  ...
  return new ImageResponse(
    <div
      style={{
        ...
        background:
          "linear-gradient(135deg, #1a0533 0%, #0f1b3c 60%, #0a1628 100%)",
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          <div
            style={{
              ...
              justifyContent: "center",
              fontSize: 54,
              boxShadow: "0 0 40px rgba(255,107,74,0.5)",
            }}
          >
            🔔
          </div>
        ...
        >
          <span style={{ fontSize: 36, fontWeight: 700, color: "#FF6B4A" }}>
            나에게 맞는 정부 지원금
          </span>
