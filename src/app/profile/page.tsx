          ...
          >
            ...
            <div>
              ...
              <p style={{ fontSize: 12, opacity: 0.85, marginTop: 2 }}>
                {lang === "ko"
                  ? "모든 프리미엄 혜택이 활성화되어 있습니다"
                  : "All premium benefits are active"}
              </p>
            </div>
          </div>
          <div
              ...
              <>
                ...
                >
                  ...
                  {lang === "ko"
                    ...
                    : "We will contact you via KakaoTalk channel for manual renewal."}
                </p>
              </>
            ) : (
              <p style={{ fontSize: 13, opacity: 0.8 }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <div>
              ...
              >
                {lang === "ko" ? "프리미엄 혜택" : "Premium Benefits"}
              </p>
              <p
                style={{
                  fontSize: 12,
...
export default function ProfilePage() {
  ...
  const [selectedSido, setSelectedSido] = useState(
    parsedRegion.sido || Object.keys(REGIONS)[0],
  );
  ...
  const toggleChildrenAgeGroup = (group: "infant" | "elementary" | "teen") => {
    ...
    const next = arr.includes(group)
      ? arr.filter((g) => g !== group)
      : [...arr, group];
        ...
        const res = await fetch("/api/user/profile", {
          ...
          body: JSON.stringify({
            ...
            age_group: finalProfile.birthYear
              ? new Date().getFullYear() - finalProfile.birthYear < 35
                ? "youth"
                : new Date().getFullYear() - finalProfile.birthYear < 60
                  ? "middle-aged"
                  : "senior"
              : undefined,
          }),
          ...
          body: JSON.stringify({
            ...
            age_group: profile.birthYear
              ? new Date().getFullYear() - profile.birthYear < 35
                ? "youth"
                : new Date().getFullYear() - profile.birthYear < 60
                  ? "middle-aged"
                  : "senior"
              : undefined,
        ...
        {kakaoUser ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div className={styles.profileHero} style={{ marginBottom: 0 }}>
              ...
              <div className={styles.profileInfo}>
                <h1 className={styles.profileName} style={{ fontSize: 16 }}>
                  {lang === "ko" ? "로그인이 필요합니다" : "Login Required"}
                </h1>
                <p className={styles.profileSub}>
                  {lang === "ko"
                    ? "카카오로 로그인하면 맞춤 혜택을 받아볼 수 있어요"
                    : "Login with Kakao to get personalized benefits"}
                </p>
              </div>
            </div>
            <div className="section" style={{ paddingTop: 0 }}>
              <div className={styles.coffeeCard}>
                ...
                <p className={styles.coffeeDesc}>
                  {lang === "ko"
                    ? "로그인하고 내 프로필 정보와 저장한 혜택을 기기 간 연동하세요."
                    : "Login to sync your profile and saved benefits across devices."}
                </p>
                <a
                  href="/api/auth/kakao"
          ...
          <div style={{ padding: "0 0 24px" }}>
            {benefitsLoading ? (
              ...
              <div style={{ textAlign: "center", padding: "56px 16px" }}>
                ...
                >
                  {lang === "ko"
                    ? "마음에 드는 혜택에 ❤️를 눌러 저장하세요"
                    : "Tap ❤️ on any benefit to save it here"}
                </p>
                <Link
                  href="/search"
                  className="btn btn-primary"
                ...
                {savedBenefits.map((b) => (
                  <div key={b.id} className={styles.bookmarkItem}>
                    ...
                    >
                      ...
                      <p className={styles.bookmarkAmount}>
                        {bText(b, "amount", lang)}
                      </p>
                    </Link>
          ...
          <>
            ...
            <section className="section">
              <h2 className="section-title mb-12">
                {lang === "ko" ? "소셜 계정 연결" : "Social Account"}
              </h2>
              {isKakaoLinked ? (
                <div
                ...
                >
                  ...
                  <p className={styles.coffeeDesc} style={{ color: "#333333" }}>
                    {lang === "ko"
                      ? "카카오 계정으로 안전하게 연결되었습니다."
                      : "Securely linked with your Kakao account."}
                  </p>
                  <button
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: 3,
                      background:
                        profileStep === 3 ? "#10b981" : "var(--primary)",
              ...
              {profileStep === 1 && (
                <div className={styles.formCard}>
                      ...
                      {employmentOptions.map((e) => (
                        <button
                          ...
                          onClick={() =>
                            update(
                              "employmentStatus",
                              e.key as UserProfile["employmentStatus"],
                            )
                          }
                        >
                          {e.label}
                  ...
                  >
                    💡{" "}
                    {lang === "ko"
                      ? "추가 정보를 입력하면 AI 혜택 매칭 정확도가 올라갑니다"
                      : "More details = better AI benefit matching accuracy"}
                  </p>
                </div>
              )}
              ...
              {profileStep === 2 && (
                <div className={styles.formCard}>
                  ...
                  >
                    ...
                    {lang === "ko"
                      ? "가족 정보 (선택 — 가족 혜택 매칭!)"
                      : "Family Info (Optional — Family Benefits!)"}
                  </p>
                  {/* 결혼 여부 */}
                  <div className={styles.formRow}>
                  ...
                  <div className={styles.formRow}>
                    ...
                    <div className={styles.stepper}>
                      <button
                        ...
                        onClick={() =>
                          updateChildrenCount(
                            Math.max(0, (profile.childrenCount || 0) - 1),
                          )
                        }
                      >
                        -
                      ...
                      <button
                        ...
                        onClick={() =>
                          updateChildrenCount(
                            Math.min(10, (profile.childrenCount || 0) + 1),
                          )
                        }
                      >
                        +
              ...
              {profileStep === 3 && (
                <div className={styles.formCard}>
                  ...
                  >
                    ...
                    {lang === "ko"
                      ? "상세 정보 (선택 — 정확도 UP!)"
                      : "Detailed Info (Optional — Better Accuracy!)"}
                  </p>
                  <div className={styles.formRow}>
                    ...
                    <div className={styles.stepper}>
                      <button
                        ...
                        onClick={() =>
                          update(
                            "householdSize",
                            Math.max(1, profile.householdSize - 1),
                          )
                        }
                      >
                        -
                      ...
                      <button
                        ...
                        onClick={() =>
                          update(
                            "householdSize",
                            Math.min(10, profile.householdSize + 1),
                          )
                        }
                      >
                        +
                  ...
                  <div className={styles.formRowFull}>
                    <div className={styles.sliderHeader}>
                      ...
                      <span className={styles.sliderValue}>
                        {lang === "ko"
                          ? `중위소득 ${profile.incomePercent}%`
                          : `${profile.incomePercent}% Median`}
                      </span>
                    </div>
                    <input
                      type="range"
                      ...
                      onChange={(e) =>
                        update("incomePercent", Number(e.target.value))
                      }
                    />
                        ...
                        <div className={styles.formRow}>
                          ...
                          <div className={styles.chipRow}>
                            <button
                              ...
                              onClick={() =>
                                update("businessType", "individual")
                              }
                            >
                              {t.individualBiz}
                            </button>
                            <button
                              ...
                              onClick={() =>
                                update("businessType", "corporation")
                              }
                            >
                              {t.corporationBiz}
                            </button>
                ...
                <div className={styles.notifRow}>
                  <div>
                    ...
                    <p className={styles.notifDesc}>
                      {lang === "ko"
                        ? "카카오톡으로 혜택 마감 알림을 받습니다"
                        : "Receive deadline alerts via KakaoTalk"}
                    </p>
                  </div>
                  <button
