...
export const metadata: Metadata = {
  ...
  description:
    "기초생활수급자, 차상위계층, 청년, 장년, 노인 등 모든 계층의 정부 지원금·복지 혜택 108건 이상을 실시간으로 확인하고 신청하세요. 의료급여, 에너지바우처, 청년 월세 지원금 등 놓치면 안 되는 혜택을 알려드립니다.",
  keywords:
  ...
  twitter: {
    ...
    description:
      "놓치면 안 되는 정부 지원금·복지 혜택을 실시간으로 확인하세요.",
  },
  robots: {
    index: true,
    follow: true,
              ...
              },
              {
                ...
                mainEntity: [
                  ...
                  },
                  {
                    ...
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: "기초생활수급자는 의료급여, 전세임대차 지원, 에너지바우처, 교육급여, 장애인 연금 등 100건 이상의 지원을 받을 수 있습니다.",
                    },
                  },
                  {
                    "@type": "Question",
